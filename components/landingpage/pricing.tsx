...
const plans = [
  {
    ...
    features: [
      { title: "100 komputerów" },
      { title: "Do tygodnia najmu" },
      { title: "Dostępne jednostki", tooltip: tooltipContent.styles },
      { title: "Nasz transport", tooltip: tooltipContent.filters },
      ...
      >
        <TabsList className="h-11 px-1.5 rounded-full bg-primary/5">
          ...
          <TabsTrigger value="yearly" className="py-1.5 rounded-full">
            Rocznie (Oszczędź {YEARLY_DISCOUNT}%)
          </TabsTrigger>
        </TabsList>
      </Tabs>
