        ...
        {features.map((feature) => (
          ...
          >
            ...
            <CardContent className="mt-auto px-0 pb-0">
              {/* Dodajemy 'relative' i 'overflow-hidden' dla zaokrąglonych rogów */}
              <div className="relative bg-yellow-500 h-52 ml-6 rounded-tl-xl overflow-hidden">
                <Image
                  src="/laptop.jpg"
                  alt="Laptop"
                  fill
                  className="object-cover" // Zachowuje proporcje, wypełniając cały obszar
                  sizes="(max-width: 768px) 100vw, 33vw" // Dobra praktyka dla wydajności
                />
              </div>
            </CardContent>
          </Card>
