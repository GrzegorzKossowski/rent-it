...
const Testimonial = () => {
  ...
  useEffect(() => {
    ...
    // Funkcja aktualizująca stan na podstawie API
    const onSelect = () => {
    ...
    // Jeśli API jest już gotowe, zainicjuj ręcznie
    onInit();

    // Subskrypcja na zdarzenia
    api.on("select", onSelect);
    api.on("reInit", onInit); // Ważne: reaguje na zmiany liczby slajdów
...
const TestimonialCard = ({
  ...
  <div className="mb-8 bg-accent rounded-xl py-8 px-6 sm:py-6" id="testimonials">
